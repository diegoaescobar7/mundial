...
$modelo->getDetallesFactura($nit, $nrofacVista);
...
while ($registro = $modelo->getRegistro()) {
    ...
    $arreglo->grupo->$contador->codproducto=$codproducto;
    $arreglo->grupo->$contador->producto=$producto;
    
    $arreglo->grupo->$contador->cantidad=$cantidad;
    $arreglo->grupo->$contador->unidad=$unidad;
    $arreglo->grupo->$contador->total=$total;
    $mauro=$mauro+1;
    $contador=$contador+1;
}
    ...
    $modelo2->getFectra($nit, $nrofacVista);
    $registro = $modelo2->getRegistro();
    $fectra = trim($registro["fectra"]);
...
$html .="  <br><small style=\"text-align: center\"><FONT color=\"#000000\">FACTURA Nro: ".$nrofacVista ."</FONT></small>";
$html .="  <br><small style=\"text-align: center\"><FONT color=\"#000000\">SUCURSAL: ".$sucursal ."</FONT></small>";
$html .="  <br><small style=\"text-align: center\"><FONT color=\"#000000\">FECHA FACTURA: ".$fectra ."</FONT></small>";
$html .="  <br><small style=\"text-align: center\"><FONT color=\"#000000\">FECHA DE VENCIMIENTO: ".$fecven ."</FONT></small>";
